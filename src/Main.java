...
public class Main {
    public static void main(String[] args) {
        ...
        while (attempts < maxiumumAttempts && !guessed) {
            ...
            if(attempts >= 3) {
                Character hint = wordle.getRandomLetterUnUsed();
                if (hint != null) {
            ...
            for (int i = 0; i < result.length; i++) {
                switch (result[i]) {
                    case 'G':
                        System.out.print("\u001B[42m\u001B[30m "  + guess.charAt(i) + " \u001B[0m ");
                        break;
                    case 'Y':
                        System.out.print("\u001B[43m\u001B[30m " + guess.charAt(i) + " \u001B[0m ");
                        break;
                    case 'X':
                        System.out.print("\u001B[41m\u001B[30m " + guess.charAt(i) + " \u001B[0m ");
                        break;
                }
            }
            System.out.println();
